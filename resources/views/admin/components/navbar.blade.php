    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg order-lg-first">
        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
          ...
          <li class="nav-item">
            <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-box"></i> Productos</a>
          ...
          <li class="nav-item dropdown">
            <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-calendar"></i> Vencimientos</a>
            <div class="dropdown-menu dropdown-menu-arrow">
          ...
          <li class="nav-item dropdown">
            <a href="{{ route('admin.users.edit', ['id' => auth()->user()->id]) }}" class="nav-link"><i class="fe fe-check-square"></i> Mi Perfil</a>
          </li>
          <li class="nav-item">
            <a href="./docs/index.html" class="nav-link"><i class="fe fe-file-text"></i> Administracion</a>
          </li>
        </ul>
      </div>
    </div>
